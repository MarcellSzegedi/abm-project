...
from abm.utils.utility_func import count_agents_in_state, unpack_riot_model_settings
...
if __name__ == "__main__":
    ...
    model_settings = RiotModelSettings()
    settings = unpack_riot_model_settings(model_settings)
    agent_data, frames = RiotModel.run_riot_model(**settings)
